...
- Name: transactions.spec.js >> TC07 — create transaction with missing amount shows error
- Location: specs/transactions.spec.js:33:1
...
- text: Email
- textbox "you@example.com": tx_1781749683677@budgetboard.com
- text: Password
