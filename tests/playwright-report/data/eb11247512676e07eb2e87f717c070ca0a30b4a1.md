...
- Name: summary.spec.js >> TC12 — balance decreases after adding expense
- Location: specs/summary.spec.js:33:1
...
Call log:
  - waiting for getByTestId('add-transaction-btn')
...
- generic [ref=e4]:
  ...
  - generic [ref=e8]:
    ...
    - textbox "you@example.com" [ref=e12]: sum_1781749704844@budgetboard.com
