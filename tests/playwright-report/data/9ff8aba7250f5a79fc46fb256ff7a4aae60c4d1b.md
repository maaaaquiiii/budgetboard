...
- Name: transactions.spec.js >> TC06 — create valid transaction appears in dashboard
- Location: specs/transactions.spec.js:21:1
...
- text: Email
- textbox "you@example.com": tx_1781749669182@budgetboard.com
- text: Password
