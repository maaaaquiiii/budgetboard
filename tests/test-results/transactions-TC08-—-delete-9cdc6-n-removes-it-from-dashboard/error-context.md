...
- Name: transactions.spec.js >> TC08 — delete transaction removes it from dashboard
- Location: specs/transactions.spec.js:46:1
...
- text: Email
- textbox "you@example.com": tx_1781749693419@budgetboard.com
- text: Password
