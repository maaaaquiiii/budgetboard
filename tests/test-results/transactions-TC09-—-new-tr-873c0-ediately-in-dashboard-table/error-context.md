...
- Name: transactions.spec.js >> TC09 — new transaction appears immediately in dashboard table
- Location: specs/transactions.spec.js:66:1
...
- text: Email
- textbox "you@example.com": tx_1781749705857@budgetboard.com
- text: Password
